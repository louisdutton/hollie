...
Visible clips play from elapsed time at their authored speed, independently of the legacy sprite-frame counters that still govern gameplay timing. The figurine's authored forward axis is world `+z`, so model rotation maps that axis onto movement and attack direction.
